...
excerpt: "새로운 게시글이 등록되었을 때, 아이콘이 보이도록 설정하는 기능의 개발 과정을 소개한다."
...
---
- 새로운 게시글이 등록되었을 때, 아이콘이 보이도록 설정하는 기능의 개발 과정을 소개한다.
...
## 새로운 글 표시 기능
- 새로운 게시글을 등록하였을 때, N 아이콘이 보이도록 설정하는 기능을 개발하려고 한다.
- 하단 이미지는 네이버 카페에서 새로운 게시글을 등록하였을 때 조그만한 N 아이콘으로 최근에 등록된 글을 표현하고 있다.
