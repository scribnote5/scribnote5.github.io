---
title:  "Workebnch에 BSP 설치 및 설정"
excerpt: "Workbench에 Sabre Lite BSP 설치 및 설정"
...
---
- Workbench에 Sabre Lite BSP 설치 및 설정
...
- 'C\Wind River\updates'(Wind River Workbench가 설치된 경로)로 이동한다.<br>
...
### 7. Workbench 재시작 후 프로젝트 생성할 때 'Board support pacakge'에서 설치한 'imx6_sabrelite' 선택 가능
