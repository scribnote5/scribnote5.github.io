...
URI: <https://www.oracle.com/java/technologies/javase-jdk11-downloads.html>
...
## 자바 환경 변수 등록
- 자바 환경 변수를 등록해야 한다. 자바 환경 변수 등록 방법은 하단 출처를 참고한다. 하단 그림 처럼 JAVA_HOME 경로는 "C:\Users\<User>\Desktop\Spring\jdk-11.0.7"로 설정한다.
