...
- 스프레드시트: <https://docs.google.com/spreadsheets/d/1FR1x1HDYq67m7YIMOM-yGH06QBDohw0gaWAJTnIYj-g/edit?usp=sharing>
 
![image](/assets/images/2021-06-16-Project Lab23, 26/image10.png)

- 생각보다 프로젝트 규모가 커짐으로서, 직접적인 프로젝트 개발에 두 명의 친구들이 관심을 가지고 참여하기로 하였다. 나 또한 프로젝트 개발 속도를 진척시키고자 친구들의 참여를 환영하고 도와줬지만, 각자 사정으로 인하여 도움만 주고 끝났다... 말과 행동은 다르다는 교훈을 다시 배우는 계기가 되었다. 
