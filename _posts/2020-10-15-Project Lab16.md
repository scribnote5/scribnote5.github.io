...
excerpt: "- Bootstrap을 사용하여 UI 변경(Front-end), 설계 변경에 따른 코드 리펙토링한 내용을 소개한다. 변경한 소스 코드 내용은 생략한다."
categories:
  - Web
  - Project Lab
...
---
- Bootstrap을 사용하여 UI 변경(Front-end), 설계 변경에 따른 코드 리펙토링한 내용을 소개한다. 변경한 소스 코드 내용은 생략한다.
