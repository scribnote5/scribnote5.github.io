...
excerpt: "- Bootstrap을 사용하여 UI 변경(Front-end), 설계 변경에 따른 코드 리펙토링한 내용을 소개한다. 개발한 소스 코드는 추후 소개할 예정이다."
categories:
  - Web
  - Project Lab
...
---
- Bootstrap을 사용하여 UI 변경(Front-end), 설계 변경에 따른 코드 리펙토링한 내용을 소개한다. 개발한 소스 코드는 추후 간략하게 소개할 예정이다.
