---
title: "리눅스 커널 시스템 호출 구현 - ARM Sabre Lite(Kernel.org)"
excerpt: "Kernel.org에서 다운받은 리눅스 커널에 시스템 호출 구현한 다음 리눅스 커널 변경하기"
...
---
- Kernel.org에서 다운받은 리눅스 커널에 시스템 호출 구현한 다음 리눅스 커널 변경하기
...
## 시스템 콜 처리 함수 등록 
\# 커널에 등록된 마지막 시스템 호출에 사용자가 구현한 시스템 콜을 추가<br>
