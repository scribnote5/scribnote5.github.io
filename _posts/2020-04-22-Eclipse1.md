...
![image](/assets/images/2020-04-14-Eclipse1/image1.png)


## Yaml Editor 플러그인 설치
- yml 파일(스프링 부트 설정 파일) 편집에 유용하다. 

![image](/assets/images/2020-04-14-Eclipse1/image2.png)


## Search Page 최적화
- Ctrl + H -> Customize... -> 필요없는 Search Page(Git Search, Plug-in Search) 제거

![image](/assets/images/2020-04-14-Eclipse1/image3.png)
