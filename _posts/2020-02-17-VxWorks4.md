...
### 1. Target Console 설정
- 상단 메뉴바 -> Window -> Preference -> Wind River -> Target Management -> Target Console -> 하단 이미지의 두 개 항목 체크 해제 <br>
...
- Remote Systems -> vxsim0 -> Wind River Launches ->  VxWorsk Kernel Task 우클릭 -> Create a new launch configuration -> Entry Point -> Browse -> CreateTasks 등록 -> Run
