...
excerpt: "태스크 생성하여 결과를 출력하는 간단한 예제를 Workbench Simulator에서 테스트"
...
---
- 태스크 생성하여 결과를 출력하는 간단한 예제를 Workbench Simulator에서 테스트
...
### 1. Target Console 설정
- 상단 메뉴바 -> Window -> Preference -> Wind River -> Target Management -> Target Console -> 하단 이미지의 두 개 항목 체크 해제 <br><br>
![image](/assets/images/2020-02-17-VxWorks/image1.png)

- 만약, Target Console을 설정하지 않는다면 다음과 같은 에러가 발생한다. <br>
...
- Remote Systems -> vxsim0 -> Wind River Launches ->  VxWorsk Kernel Task 우클릭 -> Create a new launch configuration -> Entry Point -> Browse -> CreateTasks 등록 -> Run <br>
![image](/assets/images/2020-02-17-VxWorks/image3.png)

![image](/assets/images/2020-02-17-VxWorks/image4.png)
- 시뮬레이터를 실행하면 테스크가 생성된 다음, 주기적으로 결과를 출력하는 예제를 확인할 수 있다
