...
excerpt: "다운받은 리눅스 커널을 빌드 후 리눅스 커널 버전을 변경하기"
...
---
- 다운받은 리눅스 커널을 빌드 후 리눅스 커널 버전을 변경하기
...
## 리눅스 커널 모듈 설치
\# 커널 환경설정에서 모듈로 설정한 기능들을 컴파일<br>
\# 컴파일된 모듈은 /lib/modules 아래 설치<br>
\# depmod: 모듈 사이의 의존성을 검사 후 /lib/modules 디렉토리 아래 modules.dep 파일 생성 후 설치<br>
