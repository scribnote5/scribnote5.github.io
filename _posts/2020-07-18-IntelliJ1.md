...
excerpt: "IntelliJ를 사용할 때 유용한 설정을 소개한다."
...
## 자동 import 최적화
- Settings -> Editor -> General -> Auto Import -> Optimize imports on the fly, dd unambiguous imports on the fly 체크
...
URI: <https://chrome.google.com/webstore/detail/livereload/jnihajbhpnppcggbcgedagnkighmdlei>
...
### Lombok
- Settings -> Build, Execution, Deployment -> Compliler -> Annotation Processors -> Enable annotation processing 체크 필수!
...
### Mapstruct Support
- DTO <-> Entity간 객체 Mapping 소스 코드를 자동으로 생성하는 mapstruct의 라이브러리다.