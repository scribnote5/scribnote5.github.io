...
excerpt: "- UI 변경 및 코드 리펙토링 내용을 소개한다. 개발한 소스 코드는 추후 소개할 예정이다."
categories:
  - Web
  - Project Lab
...
URI: <https://docs.google.com/spreadsheets/d/1FR1x1HDYq67m7YIMOM-yGH06QBDohw0gaWAJTnIYj-g/edit?usp=sharing>