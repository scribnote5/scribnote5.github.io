---
title:  "Wind River University Program 라이선스 발급 받기"
excerpt: "Wind River Product's University Program 라이선스 발급 받아, VxWorks 6.9에 라이선스 등록한다."
...
---
- Wind River Product's University Program 라이선스 발급 받아, VxWorks 6.9에 라이선스 등록한다.
...
- 서류 심사 절차가 이루어지며, 이후 서류 내용이 부족하거나 미흡한 경우 메일이 오며, 추가로 서류 제출을 해야한다.
...
- 'C\Wind River\license'(Workbench가 설치된 경로)로 이동한 다음 'license.lic' 파일을 생성한다. 해당 파일에 노드락 라이선스 파일 내용을 복사한다.
...
- 라이선스 등록을 마치면 Worbench가 성공적으로 실행된다.