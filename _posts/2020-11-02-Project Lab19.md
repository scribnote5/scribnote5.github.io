...
excerpt: "- 기타 페이지 개발 내용을 소개한다. 개발한 소스 코드는 추후 소개할 예정이다."
categories:
  - Web
  - Project Lab
...
---
- 관리자 페이지 개발 및 UI 변경(Front-end) 내용을 소개한다. 개발한 소스 코드는 추후 소개할 예정이다.
...
## GeoIp2
- GeoIp2는 IP 주소를 사용하여 접속 지역을 확인하는 라이브러리로서, 해당 라이브러리를 사용하여 사용자의 접속 지역 또한 DB에 저장하였다.
