...
---
- JMeter를 통하여 기능의 부하 테스트 및 성능 테스트를 수행하는 기본적인 사용 방법 소개하기



## JMeter란?
- 웹 애플리케이션에 중점을 둔 다양한 서비스의 성능을 분석하고 측정하기위한 테스트 도구다. 
- 가장 중요한 건 오픈소스 프로젝트로 무료로 사용할 수 있다는 것이다. 
...
## JMeter 실행 방법
- '<JMeter 다운로드 경로>\apache-jmeter-5.1.1\bin\jmeterw.cmd'를 실행한다. 
...
## Cookie를 이용한 로그인(cookie를 통하여 session 자동 생성하기)
