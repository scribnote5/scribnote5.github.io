---
title: "JMeter 간단 사용기"
excerpt: "JMeter를 통하여 기능의 부하 테스트 및 성능 테스트를 수행하는 기본적인 사용 방법 소개한다."
...
---
- JMeter를 통하여 기능의 부하 테스트 및 성능 테스트를 수행하는 기본적인 사용 방법 소개한다.



## JMeter란?
- 웹 애플리케이션에 중점을 둔 다양한 서비스의 성능을 분석하고 성능을 측정하기 위한 테스트 도구다. 
