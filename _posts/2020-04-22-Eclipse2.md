...
## 같은 변수, 메소드 선택시 색 반전
- 상단 메뉴바 -> Window -> Preferences -> General -> Editors -> Text Editors -> Annotations | Annotation types -> Occurrences, JavaScript Occurrences 선택 -> Show in -> Text as 체크 ->  Highlighted -> Color 선택