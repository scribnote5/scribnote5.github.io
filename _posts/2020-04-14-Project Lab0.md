...
- 소스 코드의 가독성을 위해서 위해서 적절한 위치에 주석을 추가할 것이다.
- <span style="color:red; font-weight: bold">push 하는 소스 코드가 완벽할 수는 없다. commit 이후 major한 소스 코드 수정이 발생하는 경우, push를 취소한 다음 push 할 것이다. minor한 소스 코드 수정이 발생하는 경우, 게시글의 주제와 다른 경우 다루지 않겠다. </span>
...
- WYSIWYG editor: Summernote 0.8.18