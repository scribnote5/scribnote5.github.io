...
- <span style="color:red; font-weight: bold">- commit한 소스 코드가 완벽할 수 없다. 현재 잘 작동하는 기능이 추후 언제든지 문제가 발생할 수 있고, 소스 코드 수정에 따라 프로젝트 구조가 변경될 수 있다. commit 이후 major한 소스 코드 수정이 발생하는 경우, push를 취소한 다음 push 할 것이다. minor한 소스 코드 수정이 발생하는 경우, 게시글의 주제와 다른 경우 다루지 않겠다. </span>
