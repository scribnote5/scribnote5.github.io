...
- general 권한을 가진 사용자가 root 권한을 가진 사용자가 작성한 게시글의 form 페이지의 URI 주소를 유추할 수 있고 접근할 수 있다. 따라서 사용자 권한에 따라 게시판의 create, update, delete URI에 접근 가능 여부를 구현하였다. 사용자의 권한이 없지만, form 펭지ㅣ URI에 접근하는 잘못된 접근 방식을 차단하였다. 
